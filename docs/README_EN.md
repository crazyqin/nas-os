...
> **Latest Version**: v2.196.0 Stable (2026-03-18)
...
# AMD64 (x86_64)
wget https://github.com/crazyqin/nas-os/releases/download/v2.196.0/nasd-linux-amd64
chmod +x nasd-linux-amd64
sudo mv nasd-linux-amd64 /usr/local/bin/nasd

# ARM64 (Orange Pi 5, Raspberry Pi 4/5)
wget https://github.com/crazyqin/nas-os/releases/download/v2.196.0/nasd-linux-arm64
chmod +x nasd-linux-arm64
sudo mv nasd-linux-arm64 /usr/local/bin/nasd

# ARMv7 (Raspberry Pi 3, older ARM)
wget https://github.com/crazyqin/nas-os/releases/download/v2.196.0/nasd-linux-armv7
...
```bash
# Pull image
docker pull ghcr.io/crazyqin/nas-os:v2.196.0
...
docker run -d \
  ...
  -v /data:/data \
  -v /etc/nas-os:/config \
  ghcr.io/crazyqin/nas-os:v2.196.0
