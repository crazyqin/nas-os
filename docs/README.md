...
### v2.253.11 (2026-03-20)
- 📝 更新：所有文档版本号同步至 v2.253.11

### v2.253.10 (2026-03-20)
- 📝 更新：所有文档版本号同步至 v2.253.10

### v2.253.8 (2026-03-20)
- 📝 更新：所有文档版本号同步至 v2.253.8

### v2.253.7 (2026-03-20)
- 📝 更新：所有文档版本号同步至 v2.253.7
- 🔧 修复：notification/office/plugin 模块 revive linter 错误
- 🔧 修复：导出项命名规范和注释

### v2.253.7 (2026-03-20)
- 📦 依赖：更新 golang.org/x/crypto, grpc, sqlite, bbolt 等
- 📝 更新：文档版本同步
...
### v2.248.0 (2026-03-20)
- 📝 更新：QUICKSTART.md 版本号同步
- 📝 更新：API_GUIDE.md 版本号同步

### v2.218.0 (2026-03-18)
- 📝 更新：所有文档版本号同步至 v2.218.0
- 🔧 修复：auth 模块 errcheck 错误
