...
> **最新版本**: v2.57.0 Stable (2026-03-15)
> **CI/CD**: [![CI/CD](https://github.com/crazyqin/nas-os/actions/workflows/ci-cd.yml/badge.svg)](https://github.com/crazyqin/nas-os/actions)
> **Docker**: [![Docker](https://img.shields.io/docker/v/ghcr.io/crazyqin/nas-os/v2.57.0?label=docker)](https://github.com/crazyqin/nas-os/pkgs/container/nas-os)
...
wget https://github.com/crazyqin/nas-os/releases/download/v2.57.0/nasd-linux-amd64
...
wget https://github.com/crazyqin/nas-os/releases/download/v2.57.0/nasd-linux-arm64
...
wget https://github.com/crazyqin/nas-os/releases/download/v2.57.0/nasd-linux-armv7
...
docker pull ghcr.io/crazyqin/nas-os:v2.57.0
...
docker run -d \
  ...
  ghcr.io/crazyqin/nas-os:v2.57.0
