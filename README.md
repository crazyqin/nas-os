...
> **最新版本**: v2.490.19 Stable (2026-05-12)
...
| 📊 **文件活动监控** | **实时文件操作追踪/事件记录/对标群晖Active Insight** | ✅ **v2.490.19新增** |
| ⚙️ **自定义事件规则** | **用户自定义监控规则/路径过滤/告警触发** | ✅ **v2.490.19新增** |
| 🖥️ **Fleet多节点监控** | **多节点集中监控/健康聚合/跨节点告警联动** | ✅ **v2.490.19新增** |
| 📦 **应用模板商店** | **30+常用应用一键部署模板/对标TrueNAS TrueCharts** | ✅ **v2.490.19重磅** |
| 🛡️ **AdGuard Home** | **DNS广告过滤/家庭网络防护/一键部署** | ✅ **v2.490.19新增** |
| 🖼️ **Immich** | **AI照片管理/Google Photos开源替代/一键部署** | ✅ **v2.490.19新增** |
| 🔄 **n8n** | **工作流自动化/低代码集成平台/一键部署** | ✅ **v2.490.19新增** |
| 📄 **Paperless** | **文档数字化管理/OCR智能分类/一键部署** | ✅ **v2.490.19新增** |
| 📤 **File Request** | **安全文件收集/链接分享/配额限制** | ✅ **v2.490.19新增** |
| 📊 **Alert Digest** | **告警摘要/批量通知/多通道配置** | ✅ **v2.490.19新增** |
| 💾 **Immutable Backup** | **不可变备份/SHA-256校验/审计日志/合规归档** | ✅ **v2.490.19新增** |
| 🖥️ **Storage Health Dashboard** | **统一健康监控/容量趋势预测/SMART告警** | ✅ **v2.490.19新增** |
| 🤖 **AI Console** | **本地LLM集成/隐私数据自动脱敏/OpenAI兼容API** | ✅ **v2.490.19新增** |
| 📧 **Email Moderation** | **邮件审核管控/多级审核策略/审计追踪** | ✅ **v2.490.19新增** |
| 🔄 **Smart Domain Sync** | **选择性OU同步/最小权限原则** | ✅ **v2.490.19新增** |
| 📊 **SMB 审计日志** | **SMB操作审计/文件追踪/用户记录/多通道告警** | ✅ **v2.490.19新增** |
| 🌐 **SMB 多通道聚合** | **多网卡并行传输/自适应负载均衡/自动故障切换** | ✅ **v2.490.19新增** |
| 👤 **无 Root 管理员** | **Rootless Admin/命令白名单/审计日志/对标TrueNAS** | ✅ **v2.490.19新增** |
| 📦 **LXC 容器沙箱** | **轻量级隔离环境/资源限制/内置模板/对标TrueNAS** | ✅ **v2.490.19新增** |
| 🔄 **智能数据迁移** | **SHA-256校验/带宽控制/重试策略/迁移历史** | ✅ **v2.490.19新增** |
| 🛡️ **合规仪表盘** | **安全评分/CIS/STIG/GDPR合规检查/趋势追踪** | ✅ **v2.490.19新增** |
| 💰 **预算告警管理** | **多级预算/三级告警/成本估算/趋势分析** | ✅ **v2.490.19新增** |
| 💰 **成本分析报告** | **存储成本统计/趋势预测/资源计费** | ✅ **v2.490.19新增** |
| 📡 **Prometheus 监控** | **原生指标导出/Grafana预置模板/实时WebSocket** | ✅ **v2.490.19新增** |
| 🔄 **迁移助手** | **多平台配置迁移/数据校验/进度追踪/回滚支持** | ✅ **v2.490.19新增** |
| 🔒 **NVMe-oF TLS加密** | **NVMe/TCP传输加密/mTLS双向认证/TLS 1.3** | ✅ **v2.490.19新增** |
| 📋 **NVMe-oF 访问审计** | **NVMe-oF操作审计/JSONL持久化/事件过滤** | ✅ **v2.490.19新增** |
| 📊 **存储效率统计** | **压缩比/去重比/存储池效率分析API** | ✅ **v2.490.19新增** |
| 📋 **合规报告** | **WriteOnce合规链/审计保留/Excel导出/GDPR脱敏** | ✅ **v2.490.19新增** |
| 🔌 **NVMe over Fabric** | **NVMe-oF/TCP目标管理/子系统/命名空间/端口/主机访问控制** | ✅ **v2.490.19新增** |
| 🔒 **全卷加密** | **LUKS全卷加密/密钥管理/KMIP支持/AES-NI硬件加速** | ✅ **v2.490.19重磅** |
| 💾 **块级备份** | **块级增量备份/去重压缩/速度提升2倍+/调度恢复API** | ✅ **v2.490.19新增** |
| 🐳 **Docker Compose UI** | **YAML可视化编辑/多容器一键部署/模板市场/日志监控** | ✅ **v2.490.19新增** |
| 🔐 **SSO协议扩展** | **OAuth2/OIDC/SAML/第三方应用SSO集成/客户端管理** | ✅ **v2.490.19新增** |
| 🔗 **全局文件锁** | **跨节点文件锁定/冲突检测/分布式锁服务** | ✅ **v2.490.19新增** |
| 🛡️ **设备信任** | **设备指纹识别/信任管理/新设备风险评估** | ✅ **v2.490.19新增** |
| 📦 **应用商店增强** | **批量安装/依赖解析/推荐引擎/沙箱隔离** | ✅ **v2.490.19新增** |
| 🌐 **VPN Server** | WireGuard/OpenVPN内置/用户授权/连接监控 | ✅ **v2.490.19新增** |
| 📦 **Git Server** | 自托管Git仓库/Webhook/SSH+HTTP/权限管理 | ✅ **v2.490.19新增** |
| 🖥️ **远程桌面网关** | 浏览器RDP/VNC/剪贴板同步/文件传输 | ✅ **v2.490.19新增** |
| 🏠 **家庭仪表盘** | 智能家居+NAS统一面板/可配置Widget | ✅ **v2.490.19新增** |
| 💰 **成本预测** | 存储成本趋势预测/优化建议/多维分析 | ✅ **v2.490.19新增** |
| 📊 **预算管理** | 企业级存储预算/审批流程/超支告警 | ✅ **v2.490.19新增** |
| 💬 **Chat即时通讯** | WebSocket实时消息/群组/频道/消息搜索/未读计数 | ✅ **v2.490.19新增** |
| ⚡ **SMB Multichannel增强** | 多通道并行传输/带宽监控/会话管理 | ✅ **v2.490.19新增** |
| 🌐 **网络测速** | 下载/上传/延迟测试/历史记录/服务器管理 | ✅ **v2.490.19新增** |
| ☁️ **云存储成本分析** | 多云费用追踪/对比分析/优化建议/告警 | ✅ **v2.490.19新增** |
| 🔒 **安全评分** | 系统安全态势/多维检查/等级评分/历史趋势/改进建议 | ✅ **v2.490.19新增** |
| 📋 **审计报告** | 安全审计/合规检查/事件日志/安全扫描/JSONL导出 | ✅ **v2.490.19新增** |
...
# 下载 (根据你的架构选择)
# AMD64 (x86_64)
wget https://github.com/crazyqin/nas-os/releases/download/v2.490.19/nasd-linux-amd64
chmod +x nasd-linux-amd64
sudo mv nasd-linux-amd64 /usr/local/bin/nasd

# ARM64 (Orange Pi 5, Raspberry Pi 4/5)
wget https://github.com/crazyqin/nas-os/releases/download/v2.490.19/nasd-linux-arm64
chmod +x nasd-linux-arm64
sudo mv nasd-linux-arm64 /usr/local/bin/nasd

# ARMv7 (Raspberry Pi 3, 旧款 ARM)
wget https://github.com/crazyqin/nas-os/releases/download/v2.490.19/nasd-linux-armv7
...
```bash
# 拉取镜像
docker pull ghcr.io/crazyqin/nas-os:v2.490.19
...
docker run -d \
  ...
  -v /data:/data \
  -v /etc/nas-os:/config \
  ghcr.io/crazyqin/nas-os:v2.490.19
...
| 功能 | 说明 | 预计发布 |
|------|------|----------|
| 💾 **RAIDZ扩展** | 存储池在线扩容，单盘扩展无需重建 | v2.490.19 (M106) |
...
### 当前状态 (2026-03-20) - v2.490.19 Stable ✅
...
| 版本 | 类型 | 发布日期 | 核心功能 | 状态 |
|------|------|----------|----------|------|
| v2.490.19 | Alpha | 2026-03-10 | 项目骨架、btrfs 基础 | ✅ 发布 |
| v2.490.19 | Alpha | 2026-03-10 | 文件共享、配置持久化 | ✅ 发布 |
| v2.490.19 | Stable | 2026-03-11 | 生产就绪版本 | ✅ 已发布 |
| v2.490.19 | Stable | 2026-03-12 | 功能大更新 (10 个新模块) | ✅ 已发布 |
| v2.490.19 | Stable | 2026-03-12 | 安全加固与性能优化 | ✅ 已发布 |
| v2.490.19 | Stable | 2026-03-12 | 容器管理和 VM 功能 | ✅ 已发布 |
| v1.4.x | Stable | 2026-03-12 | RBAC 权限系统 + WebUI | ✅ 已发布 |
| v1.5.x | Stable | 2026-03-13 | 监控告警系统 + WebUI | ✅ 已发布 |
| v2.490.19 | Stable | 2026-03-13 | 性能优化 + CI/CD 完善 | ✅ 已发布 |
| v2.490.19 | Stable | 2026-03-13 | 配额/回收站/WebDAV/复制/AI | ✅ 已发布 |
| v2.490.19 | Stable | 2026-03-20 | 版本控制/云同步/去重 | ✅ 已发布 |
| v2.490.19 | Stable | 2026-04-01 | 存储复制/回收站增强 | ✅ 已发布 |
| **v2.490.19** | **Stable** | **2026-03-21** | **iSCSI/快照策略/仪表板增强/性能监控** | ✅ **已发布** |
| **v2.490.19** | **Stable** | **2026-03-28** | **存储分层/FTP-SFTP/压缩存储/文件标签** | ✅ **已发布** |
| **v2.490.19** | **Stable** | **2026-03-14** | **集成测试完善/文档更新** | ✅ **已发布** |
| **v2.490.19** | **Stable** | **2026-03-14** | **快照复制/高可用/备份恢复集成测试** | ✅ **已发布** |
| **v2.490.19** | **Stable** | **2026-03-14** | **安全增强/性能优化/集成测试完善** | ✅ **已发布** |
| **v2.490.19** | **Stable** | **2026-03-14** | **Bug 修复/测试完善/安全审计** | ✅ 已发布 |
| **v2.490.19** | **Stable** | **2026-03-14** | **gin 依赖修复/CI/CD 修复** | ✅ 已发布 |
| **v2.490.19** | **Stable** | **2026-03-14** | **CI/CD 修复/代码质量改进** | ✅ 已发布 |
| **v2.490.19** | **Stable** | **2026-03-14** | **SMB/NFS 修复/Go 1.25 升级/安全审计** | ✅ 已发布 |
| **v2.490.19** | **Stable** | **2026-03-14** | **SQLite 驱动替换/测试覆盖率提升/WebUI 完善** | ✅ 已发布 |
| **v2.490.19** | **Stable** | **2026-03-15** | **预测分析/i18n 国际化/API 文档系统** | ✅ 已发布 |
| **v2.490.19** | **Stable** | **2026-03-14** | **文档完善/版本更新** | ✅ 已发布 |
| **v2.490.19** | **Stable** | **2026-03-15** | **功能完善/代码质量** | ✅ 已发布 |
| **v2.490.19** | **Stable** | **2026-03-15** | **数据竞争修复/并发安全** | ✅ 已发布 |
| **v2.490.19** | **Stable** | **2026-03-14** | **代码清理/CI优化/文档完善** | ✅ 已发布 |
| **v2.490.19** | **Stable** | **2026-03-15** | **网络诊断/Docker 增强/自动化完善** | ✅ 已发布 |
| **v2.490.19** | **Stable** | **2026-03-15** | **媒体服务/配额自动扩展/监控增强** | ✅ 已发布 |
| **v2.490.19** | **Stable** | **2026-03-15** | **文档完善/API 文档覆盖** | ✅ 已发布 |
| **v2.490.19** | **Stable** | **2026-03-15** | **API 文档完善/国际化更新** | ✅ 已发布 |
| **v2.490.19** | **Stable** | **2026-03-15** | **请求日志/Excel导出/开发环境增强** | ✅ 已发布 |
| **v2.490.19** | **Stable** | **2026-03-15** | **i18n框架/API中间件/成本分析** | ✅ 已发布 |
| **v2.490.19** | **Stable** | **2026-03-15** | **国际化补全/CI优化/文档更新** | ✅ 已发布 |
| **v2.490.19** | **Stable** | **2026-03-15** | **文档同步/版本号更新** | ✅ 已发布 |
| **v2.490.19** | **Stable** | **2026-03-15** | **项目治理/文档体系完善** | ✅ 已发布 |
| **v2.490.19** | **Stable** | **2026-03-15** | **安全审计/并发修复/CI优化** | ✅ 已发布 |
| **v2.490.19** | **Stable** | **2026-03-15** | **测试修复/CI优化/Swagger文档** | ✅ 已发布 |
| **v2.490.19** | **Stable** | **2026-03-15** | **测试修复/文档完善** | ✅ 已发布 |
| **v2.490.19** | **Stable** | **2026-03-15** | **文档体系完善/用户指南优化/API文档补充** | ✅ 已发布 |
| **v2.490.19** | **Stable** | **2026-03-20** | **代码质量提升/Lint修复/安全加固/六部协同** | ✅ 已发布 |
| **v2.490.19** | **Stable** | **2026-03-21** | **依赖更新/安全增强/文档同步** | ✅ **已发布** |
| **v2.490.19** | **Stable** | **2026-03-24** | **网盘挂载/AI脱敏/智能分层** | ✅ **已发布** |
| **v2.490.19** | **Stable** | **2026-03-21** | **版本迭代/六部协同维护** | ✅ **已发布** |
...
| 📚 文档更新 | CHANGELOG 添加 v2.490.19，README 版本号同步 |
...
<details>
<summary>v2.490.19 新增功能</summary>
