...
> **最新版本**: v2.170.0 Stable (2026-03-17)
...
wget https://github.com/crazyqin/nas-os/releases/download/v2.168.0/nasd-linux-amd64
chmod +x nasd-linux-amd64
sudo mv nasd-linux-amd64 /usr/local/bin/nasd

# ARM64 (Orange Pi 5, Raspberry Pi 4/5)

wget https://github.com/crazyqin/nas-os/releases/download/v2.168.0/nasd-linux-arm64
chmod +x nasd-linux-arm64
sudo mv nasd-linux-arm64 /usr/local/bin/nasd

# ARMv7 (Raspberry Pi 3, 旧款 ARM)

wget https://github.com/crazyqin/nas-os/releases/download/v2.168.0/nasd-linux-armv7
...
docker pull ghcr.io/crazyqin/nas-os:v2.168.0
...
docker run -d \
  ...
  ghcr.io/crazyqin/nas-os:v2.168.0
