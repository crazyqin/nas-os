...
> **最新版本**: v2.253.84 Stable (2026-03-21)
> **CI/CD**: [![CI/CD](https://github.com/crazyqin/nas-os/actions/workflows/ci-cd.yml/badge.svg)](https://github.com/crazyqin/nas-os/actions)
> **Docker**: [![Docker](https://img.shields.io/docker/v/ghcr.io/crazyqin/nas-os/v2.253.84?label=docker)](https://github.com/crazyqin/nas-os/pkgs/container/nas-os)
...
wget https://github.com/crazyqin/nas-os/releases/download/v2.253.84/nasd-linux-amd64
chmod +x nasd-linux-amd64
sudo mv nasd-linux-amd64 /usr/local/bin/nasd

# ARM64 (Orange Pi 5, Raspberry Pi 4/5)

wget https://github.com/crazyqin/nas-os/releases/download/v2.253.84/nasd-linux-arm64
chmod +x nasd-linux-arm64
sudo mv nasd-linux-arm64 /usr/local/bin/nasd

# ARMv7 (Raspberry Pi 3, 旧款 ARM)

wget https://github.com/crazyqin/nas-os/releases/download/v2.253.84/nasd-linux-armv7
...
docker pull ghcr.io/crazyqin/nas-os:v2.253.84
...
ghcr.io/crazyqin/nas-os:v2.253.84
...
| **v2.253.75** | **Stable** | **2026-03-20** | **代码规范修复/golangci-lint优化** | ✅ 已发布 |
| **v2.253.75** | **Stable** | **2026-03-20** | **合并冲突修复/Lint完善/六部协同完成** | ✅ **已发布** |
