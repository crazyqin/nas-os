...
> **最新版本**: v2.485.0 Stable (2026-05-06)
...
| 🌐 **SMB 多通道聚合** | **多网卡并行传输/自适应负载均衡/自动故障切换** | ✅ **v2.477.0新增** |
| 👤 **无 Root 管理员** | **Rootless Admin/命令白名单/审计日志/对标TrueNAS** | ✅ **v2.477.0新增** |
| 📦 **LXC 容器沙箱** | **轻量级隔离环境/资源限制/内置模板/对标TrueNAS** | ✅ **v2.477.0新增** |
| 🔄 **智能数据迁移** | **SHA-256校验/带宽控制/重试策略/迁移历史** | ✅ **v2.477.0新增** |
| 🛡️ **合规仪表盘** | **安全评分/CIS/STIG/GDPR合规检查/趋势追踪** | ✅ **v2.477.0新增** |
| 💰 **预算告警管理** | **多级预算/三级告警/成本估算/趋势分析** | ✅ **v2.477.0新增** |
...
| 🔒 **NVMe-oF TLS加密** | **NVMe/TCP传输加密/mTLS双向认证/TLS 1.3** | ✅ **v2.478.0新增** |
| 📋 **NVMe-oF 访问审计** | **NVMe-oF操作审计/JSONL持久化/事件过滤** | ✅ **v2.478.0新增** |
| 📊 **存储效率统计** | **压缩比/去重比/存储池效率分析API** | ✅ **v2.478.0新增** |
...
| 🔒 **安全评分** | 系统安全态势/多维检查/等级评分/历史趋势/改进建议 | ✅ **v2.485.0新增** |
| 📋 **审计报告** | 安全审计/合规检查/事件日志/安全扫描/JSONL导出 | ✅ **v2.485.0新增** |
...
| 功能 | 说明 | 预计发布 |
|------|------|----------|
| 💾 **RAIDZ扩展** | 存储池在线扩容，单盘扩展无需重建 | v2.320.0 (M106) |
