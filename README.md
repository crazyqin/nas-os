...
> **最新版本**: v3.24.1 Stable (2026-07-16)
...
> **Release**: [v3.24.1](https://github.com/crazyqin/nas-os/releases/tag/v3.24.1)
...
| 🔀 **SMB有状态HA故障转移** | 会话状态跨控制器故障转移保持/SMB Guardian | ✅ **v3.1.0新增** |
| 📊 **数据分层自定义规则** | 按访问频率/时间自动冷热数据分层/用户自定义策略 | ✅ **v3.1.0新增** |
| 📧 **邮件OAuth通知** | 支持Gmail/Outlook OAuth2授权/安全邮件通知 | ✅ **v3.1.0新增** |
| 🔌 **WebSocket API** | JSON-RPC 2.0 + SCRAM-SHA-512认证/实时通信 | ✅ **v3.1.0新增** |
| 🔐 **弹性存储加密** | AES-256-XTS密码解锁加密存储/动态密钥管理 | ✅ **v3.1.0新增** |
| 📋 **邮件审核机制** | 敏感邮件管理员审批工作流/多级审核策略 | ✅ **v3.1.0新增** |
...
### 当前状态 (2026-07-16) - v3.24.1 Stable ✅
