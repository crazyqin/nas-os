...
> **最新版本**: v2.253.105 Stable (2026-03-21)
> **CI/CD**: [![CI/CD](https://github.com/crazyqin/nas-os/actions/workflows/ci-cd.yml/badge.svg)](https://github.com/crazyqin/nas-os/actions)
> **Docker**: [![Docker](https://img.shields.io/docker/v/ghcr.io/crazyqin/nas-os/v2.253.105?label=docker)](https://github.com/crazyqin/nas-os/pkgs/container/nas-os)
