...
> **最新版本**: v2.253.238 Stable (2026-03-23)
> **CI/CD**: [![CI/CD](https://github.com/crazyqin/nas-os/actions/workflows/ci-cd.yml/badge.svg)](https://github.com/crazyqin/nas-os/actions)
> **Docker**: [![Docker](https://img.shields.io/docker/v/ghcr.io/crazyqin/nas-os/v2.253.238?label=docker)](https://github.com/crazyqin/nas-os/pkgs/container/nas-os)
...
# 下载 (根据你的架构选择)
# AMD64 (x86_64)
wget https://github.com/crazyqin/nas-os/releases/download/v2.253.238/nasd-linux-amd64
chmod +x nasd-linux-amd64
sudo mv nasd-linux-amd64 /usr/local/bin/nasd

# ARM64 (Orange Pi 5, Raspberry Pi 4/5)
wget https://github.com/crazyqin/nas-os/releases/download/v2.253.238/nasd-linux-arm64
chmod +x nasd-linux-arm64
sudo mv nasd-linux-arm64 /usr/local/bin/nasd

# ARMv7 (Raspberry Pi 3, 旧款 ARM)
wget https://github.com/crazyqin/nas-os/releases/download/v2.253.238/nasd-linux-armv7
...
```bash
# 拉取镜像
docker pull ghcr.io/crazyqin/nas-os:v2.253.238
...
docker run -d \
  ...
  -v /data:/data \
  -v /etc/nas-os:/config \
  ghcr.io/crazyqin/nas-os:v2.253.238
...
| v2.253.238 | Stable | 2026-04-01 | 存储复制/回收站增强 | ✅ 已发布 |
| **v2.253.238** | **Stable** | **2026-03-21** | **iSCSI/快照策略/仪表板增强/性能监控** | ✅ **已发布** |
| **v2.253.238** | **Stable** | **2026-03-28** | **存储分层/FTP-SFTP/压缩存储/文件标签** | ✅ **已发布** |
| **v2.253.238** | **Stable** | **2026-03-14** | **集成测试完善/文档更新** | ✅ **已发布** |
| **v2.253.238** | **Stable** | **2026-03-14** | **快照复制/高可用/备份恢复集成测试** | ✅ **已发布** |
| **v2.253.238** | **Stable** | **2026-03-14** | **安全增强/性能优化/集成测试完善** | ✅ **已发布** |
| **v2.253.238** | **Stable** | **2026-03-14** | **Bug 修复/测试完善/安全审计** | ✅ 已发布 |
| **v2.253.238** | **Stable** | **2026-03-14** | **gin 依赖修复/CI/CD 修复** | ✅ 已发布 |
| **v2.253.238** | **Stable** | **2026-03-14** | **CI/CD 修复/代码质量改进** | ✅ 已发布 |
| **v2.253.238** | **Stable** | **2026-03-14** | **SMB/NFS 修复/Go 1.25 升级/安全审计** | ✅ 已发布 |
| **v2.253.238** | **Stable** | **2026-03-14** | **SQLite 驱动替换/测试覆盖率提升/WebUI 完善** | ✅ 已发布 |
| **v2.253.238** | **Stable** | **2026-03-15** | **预测分析/i18n 国际化/API 文档系统** | ✅ 已发布 |
| **v2.253.238** | **Stable** | **2026-03-14** | **文档完善/版本更新** | ✅ 已发布 |
| **v2.253.238** | **Stable** | **2026-03-15** | **功能完善/代码质量** | ✅ 已发布 |
| **v2.253.238** | **Stable** | **2026-03-15** | **数据竞争修复/并发安全** | ✅ 已发布 |
| **v2.253.238** | **Stable** | **2026-03-14** | **代码清理/CI优化/文档完善** | ✅ 已发布 |
| **v2.253.238** | **Stable** | **2026-03-15** | **网络诊断/Docker 增强/自动化完善** | ✅ 已发布 |
| **v2.253.238** | **Stable** | **2026-03-15** | **媒体服务/配额自动扩展/监控增强** | ✅ 已发布 |
| **v2.253.238** | **Stable** | **2026-03-15** | **文档完善/API 文档覆盖** | ✅ 已发布 |
| **v2.253.238** | **Stable** | **2026-03-15** | **API 文档完善/国际化更新** | ✅ 已发布 |
| **v2.253.238** | **Stable** | **2026-03-15** | **请求日志/Excel导出/开发环境增强** | ✅ 已发布 |
| **v2.253.238** | **Stable** | **2026-03-15** | **i18n框架/API中间件/成本分析** | ✅ 已发布 |
| **v2.253.238** | **Stable** | **2026-03-15** | **国际化补全/CI优化/文档更新** | ✅ 已发布 |
| **v2.253.238** | **Stable** | **2026-03-15** | **文档同步/版本号更新** | ✅ 已发布 |
| **v2.253.238** | **Stable** | **2026-03-15** | **项目治理/文档体系完善** | ✅ 已发布 |
| **v2.253.238** | **Stable** | **2026-03-15** | **安全审计/并发修复/CI优化** | ✅ 已发布 |
| **v2.253.238** | **Stable** | **2026-03-15** | **测试修复/CI优化/Swagger文档** | ✅ 已发布 |
| **v2.253.238** | **Stable** | **2026-03-15** | **测试修复/文档完善** | ✅ 已发布 |
| **v2.253.238** | **Stable** | **2026-03-15** | **文档体系完善/用户指南优化/API文档补充** | ✅ 已发布 |
| **v2.253.238** | **Stable** | **2026-03-20** | **代码质量提升/Lint修复/安全加固/六部协同** | ✅ 已发布 |
| **v2.253.238** | **Stable** | **2026-03-21** | **依赖更新/安全增强/文档同步** | ✅ **已发布** |
| **v2.253.238** | **Stable** | **2026-03-21** | **版本迭代/六部协同维护** | ✅ **已发布** |
...
| 📚 文档更新 | CHANGELOG 添加 v2.253.238，README 版本号同步 |
...
<details>
<summary>v2.253.238 新增功能</summary>
