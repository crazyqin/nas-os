...
> **最新版本**: v2.253.48 Stable (2026-03-20)
> **CI/CD**: [![CI/CD](https://github.com/crazyqin/nas-os/actions/workflows/ci-cd.yml/badge.svg)](https://github.com/crazyqin/nas-os/actions)
> **Docker**: [![Docker](https://img.shields.io/docker/v/ghcr.io/crazyqin/nas-os/v2.253.48?label=docker)](https://github.com/crazyqin/nas-os/pkgs/container/nas-os)
...
wget https://github.com/crazyqin/nas-os/releases/download/v2.253.48/nasd-linux-amd64
chmod +x nasd-linux-amd64
sudo mv nasd-linux-amd64 /usr/local/bin/nasd

# ARM64 (Orange Pi 5, Raspberry Pi 4/5)

wget https://github.com/crazyqin/nas-os/releases/download/v2.253.48/nasd-linux-arm64
chmod +x nasd-linux-arm64
sudo mv nasd-linux-arm64 /usr/local/bin/nasd

# ARMv7 (Raspberry Pi 3, 旧款 ARM)

wget https://github.com/crazyqin/nas-os/releases/download/v2.253.48/nasd-linux-armv7
...
docker pull ghcr.io/crazyqin/nas-os:v2.253.48
...
ghcr.io/crazyqin/nas-os:v2.253.48
